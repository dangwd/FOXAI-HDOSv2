...
const ALERT_POOL = [
  ...
  },
  {
    code: "INR",
    text: "INR > 4.5",
    patient: "BN: Bùi Thị Hoa",
    dept: "Khoa Huyết học",
    severity: "warning" as const,
  },
  {
    code: "Glc",
    text: "Glucose > 28 mmol/L",
    patient: "BN: Ngô Văn Hùng",
    dept: "Khoa Nội tổng quát",
    severity: "critical" as const,
  },
  {
  ...
  },
  {
    code: "HR",
    text: "HR > 145 bpm",
    patient: "BN: Đỗ Thị Mai",
    dept: "Khoa Tim mạch",
    severity: "critical" as const,
  },
  {
    code: "BP",
    text: "HA tâm thu > 200 mmHg",
    patient: "BN: Phan Văn Nam",
    dept: "Khoa Cấp cứu",
    severity: "critical" as const,
  },
  {
    code: "Lac",
    text: "Lactate > 4.0 mmol/L",
    patient: "BN: Nguyễn Thị Oanh",
  ...
  },
  {
    code: "WBC",
    text: "WBC > 25 G/L",
    patient: "BN: Lưu Thị Quỳnh",
    dept: "Khoa Huyết học",
    severity: "warning" as const,
  },
  {
    code: "PCT",
    text: "Procalcitonin > 10 ng/mL",
    patient: "BN: Mai Văn Sơn",
    dept: "Khoa Nhiễm",
    severity: "critical" as const,
  },
  {
    code: "Plt",
    text: "Tiểu cầu < 20 G/L",
    patient: "BN: Đặng Thị Thủy",
    dept: "Khoa Huyết học",
    severity: "critical" as const,
  },
];
...
function randomTime(): string {
  ...
  if (r < 0.2) return `${10 + Math.round(Math.random() * 50)} giây trước`;
