...
import { Database, Plus, RefreshCw, Search, TableProperties } from "lucide-react";
...
export default function LakehouseViewsPage() {
  ...
  const [drawerTarget, setDrawerTarget] = useState<ViewBinding | "create" | null>(null);
  ...
  const headerStats = manager.bindings.length > 0
    ? [
        {
          label: "Bindings",
  ...
  return (
    <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{
        ...
        background:     "linear-gradient(135deg, rgba(56,189,248,0.08) 0%, rgba(56,189,248,0.03) 55%, transparent 100%)",
        padding:        "20px 24px",
        display:        "flex",
        alignItems:     "center",
        gap:            20,
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <Text type="secondary" style={{ fontSize: 13 }}>
            Đăng ký PostgreSQL view ↔ SourceProfile để WarehousePollerWorker tự động ingest qua
            unified pipeline (doc 44).
          </Text>
        </div>
